<template>
    <div class="flex flex-wrap gap-x-3 mb-3 text-zinc-900 dark:text-white items-center">
        <!-- eslint-disable-next-line vue/no-v-html -->
        <p v-if="currentSet.description" class="grow prose prose-zinc dark:prose-invert max-w-none" v-html="styleAndSanitize(currentSet.description, true)" />
...
import { isStudyGuide, showErrorToast, studyGuideItemIsReading } from '../../utils';
