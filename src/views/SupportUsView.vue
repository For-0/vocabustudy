<template>
    <main class="grow">
        <section class="striped-background h-[calc(60vh)]">
            <div class="max-w-screen-xl px-4 py-8 mx-auto lg:py-16 text-center flex items-center justify-center flex-col h-full">
                <h1 class="max-w-2xl mb-4 text-4xl font-extrabold md:text-5xl xl:text-6xl text-white mx-auto">Support us to change the <span class="text-primary-alt">world</span></h1>
                <p class="max-w-2xl mb-6 font-light text-white lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400 mx-auto">Help support us on our mission to change the world and free our education tools from paywalls.</p>         
            </div>
        </section>
        <section>
            <div class="bg-stone-200 dark:bg-stone-800 p-10">
                <h2 class="max-w-2xl mb-4 text-3xl font-extrabold md:text-4xl xl:text-5xl dark:text-white">Support us for <span class="text-primary">free</span></h2>
                <p class="mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">Can't make a donation? No problem! You can help us just as much by doing the following:</p>
                <ul class="my-5" style="list-style-type: disc;">
                ...
                <p class="mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">If you can make a paid donation, thank you! We use Buy Me a Coffee for donations.</p>
