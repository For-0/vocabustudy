<template>
    <main class="bg-white dark:bg-zinc-900">
        ...
        >
            Terms of Service
            <span
                class="bg-zinc-100 text-zinc-800 text-xs font-medium inline-flex items-center px-2.5 py-0.5 rounded ml-2 dark:bg-zinc-700 dark:text-zinc-400 border border-zinc-500"
                title="Last Updated"
            >
                <ClockIcon class="w-2.5 h-2.5 mr-1.5" /> Mar 31, 2023
            </span>
        </h1>
        <p class="leading-tight font-extrabold  text-zinc-900 dark:text-white ml-10 mr-10 lg:ml-20 mb-1">
            Have a question? Email
            <a href="mailto:management@vocabustudy.org" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">management@vocabustudy.org</a>.
        </p>
        <hr style="max-width: 600px;" class="border border-zinc-400 rounded-md dark:border-white ml-10 mr-10 lg:ml-20 mb-5 mt-5">

        <section class="text-zinc-900 dark:text-white ml-10 mr-10 lg:ml-20 mt-5" style="max-width: 800px;">
            <h1 class="text-2xl font-extrabold leading-tight text-zinc-900 sm:text-xl dark:text-white">
                1. Agreement to Terms
            </h1>
            <p>
                These Terms of Use constitute a legally binding agreement made between you, whether personally or on behalf
                of an entity ("<b>you</b>") and For Zero Applications ("<b>Company</b>," "<b>we</b>," "<b>us</b>," or
                "<b>our</b>"), concerning your access to and use of the
                <a href="https://vocabustudy.org" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">https://vocabustudy.org</a>
                website as well as any other media form, media channel, mobile website or mobile application related, linked, or
                otherwise connected thereto (collectively, the "<b>Site</b>"). You agree that by accessing the Site, you
                ...
                of each such change. Please ensure that you check the applicable Terms every time you use our Site so that
                you understand which Terms apply. You will be subject to, and will be deemed to have been made aware of and
                ...
                <br><br>
                All users who are under the age of 13 must have the permission of, and be directly supervised by, their
                parent or guardian to use the Site.
            </p>
        </section>
        <section class="text-zinc-900 dark:text-white ml-10 mr-10 lg:ml-20 mt-5" style="max-width: 800px;">
            <h1 class="text-2xl font-extrabold leading-tight text-zinc-900 sm:text-xl dark:text-white">
            ...
            <p>
                ...
                (collectively, the "<b>Content</b>") and the trademarks, service marks, and logos contained therein (the
                "<b>Marks</b>") are owned or controlled by us or licensed to us, and are protected by copyright and
                ...
                on the Site "AS IS" for your information and personal use only. Except as expressly provided in these Terms
        ...
        <section class="text-zinc-900 dark:text-white ml-10 mr-10 lg:ml-20 mt-5" style="max-width: 800px;">
            ...
            <p>
                ...
                these Terms of Use; (4) you will not access the Site through automated or non-human means, whether through a
                bot, script, or otherwise; (5) you will not use the Site for any illegal or unauthorized purpose; and (6)
        ...
        <section class="text-zinc-900 dark:text-white ml-10 mr-10 lg:ml-20 mt-5" style="max-width: 800px;">
            ...
            <p>
                You are not required to register with the Site. You agree to keep your password confidential and will be
        ...
        <section class="text-zinc-900 dark:text-white ml-10 mr-10 lg:ml-20 mt-5" style="max-width: 800px;">
            ...
            <p>
                ...
                <ul style="list-style-type: disc;" class="m-5">
                    <li>
                    ...
                    <li>Create sets that are in no way educational.</li>
                </ul>
            </p>
        </section>
        <section class="text-zinc-900 dark:text-white ml-10 mr-10 lg:ml-20 mt-5" style="max-width: 800px;">
            ...
            <p>
                ...
                <ul style="list-style-type: disc;" class="m-5">
                    ...
                    <li>
                        Your Contributions are not intended to hinder or otherwise interfere with the experience of other Users,
                        through methods such as spamming, hacking, or placing said Contribution in excessive and unrelated
                        "collections".
                    </li>
                    <li>
        ...
        <section class="text-zinc-900 dark:text-white ml-10 mr-10 lg:ml-20 mt-5" style="max-width: 800px;">
            ...
            <p>
                ...
                <br><br>
                As stated above, any Contributions which do not meet the above criteria will be made "unlisted" as a matter
                of courtesy. We reserve the right to make your Contributions unlisted at any time and for any reason,
                without notice. Re-publishing these Contributions on the Site is prohibited and may result in a temporary
                ban.
            </p>
        </section>
        <section class="text-zinc-900 dark:text-white ml-10 mr-10 lg:ml-20 mt-5" style="max-width: 800px;">
        ...
        <section class="text-zinc-900 dark:text-white ml-10 mr-10 lg:ml-20 mt-5" style="max-width: 800px;">
            ...
            <p>
                ...
                regarding the Site ("<b>Submissions</b>") provided by you to us are non-confidential and shall become our
        ...
        <section class="text-zinc-900 dark:text-white ml-10 mr-10 lg:ml-20 mt-5" style="max-width: 800px;">
            ...
            <p>
                The Site may contain (or you may be sent via the Site) links to other websites ("<b>Third-Party
                    Websites</b>") as well as articles, photographs, text, graphics, pictures, designs, music, sound, video,
                information, applications, software, and other content or items belonging to or originating from third
                parties ("<b>Third-Party Content</b>"). Such Third-Party Websites and Third-Party Content are not
        ...
        <section class="text-zinc-900 dark:text-white ml-10 mr-10 lg:ml-20 mt-5" style="max-width: 800px;">
            ...
            <p>
                We care about data privacy and security. Please review our Privacy Policy: <a
                    href="https://vocabustudy.org/privacy"
                    class="font-medium text-blue-600 dark:text-blue-500 hover:underline"
                >https://vocabustudy.org/privacy</a>.
        ...
        <section class="text-zinc-900 dark:text-white ml-10 mr-10 lg:ml-20 mt-5" style="max-width: 800px;">
            ...
            <!-- eslint-disable -->
            <p>
                <h3 class="font-extrabold mt-2 mb-2">
                ...
                THAT WITHOUT THIS PROVISION, YOU WOULD HAVE THE RIGHT TO SUE IN COURT AND HAVE A JURY TRIAL. The arbitration
                ...
                <a href="https://www.adr.org" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">https://www.adr.org</a>.
                ...
                AAA rules or applicable law, the arbitration will take place in United States, Texas. Except as otherwise
                provided herein, the Parties may litigate in court to compel arbitration, stay proceedings pending arbitration,
                ...
                prosecuted in the state and federal courts located in Travis County, and the Parties hereby consent to, and
                ...
                International Sale of Goods and the Uniform Computer Information Transaction Act (UCITA) is excluded from these
                Terms of Use.
                <br><br>
        ...
        <section class="text-zinc-900 dark:text-white ml-10 mr-10 lg:ml-20 mt-5" style="max-width: 800px;">
            ...
            <p>
                ...
                $0.00 USD. CERTAIN US STATE LAWS AND INTERNATIONAL LAWS DO NOT ALLOW LIMITATIONS ON IMPLIED WARRANTIES OR
        ...
        <section class="text-zinc-900 dark:text-white ml-10 mr-10 lg:ml-20 mt-5" style="max-width: 800px;">
            ...
            <p>
                ...
                the Site, as well as data relating to your use of the Site. Although we may perform regular routine backups
        ...
        <section class="text-zinc-900 dark:text-white ml-10 mr-10 lg:ml-20 mt-5 mb-5" style="max-width: 800px;">
            <h1 class="text-2xl font-extrabold leading-tight text-zinc-900 sm:text-xl dark:text-white">
                25. Contact Us
            </h1>
            <p>
                In order to resolve a complaint regarding the Site or to receive further information regarding use of the
                Site, please contact us at: <a
                    href="mailto:management@vocabustudy.org"
                    class="font-medium text-blue-600 dark:text-blue-500 hover:underline"
                >management@vocabustudy.org</a>.
            </p>
        </section>
    </main>
</template>
